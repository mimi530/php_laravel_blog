                ...
                <div class="row mb-5 p-2">
                    <div class="col-10 offset-1 offset-md-0 col-md-12 d-md-flex p-0">
                        <div class="col-12 col-md-4 p-0 mb-3 mb-md-0">
                            <a href="storage/{{$post->image}}"><img src="storage/{{$post->image}}" class="w-100 rounded-left"></a>
                        </div>
                        <div class="col-12 col-md-8">
                            <a href="{{route('posts.show', $post->id)}}"><h1>{{ $post->title }}</h1></a>
                            <p class="h5" html="true">{{ \Illuminate\Support\Str::limit($post->contents, 250, $end='... ') }}<a href="{{route('posts.show', $post->id)}}"><br>Czytaj dalej</a></p>
                        </div>
                    </div>
                </div>
            @endforeach
